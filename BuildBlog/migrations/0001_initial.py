    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='buildblog_buildblogentry_related', to=settings.AUTH_USER_MODEL)),
                ('category', models.ManyToManyField(to='BuildBlog.BuildBlogCategory', verbose_name='Category')),
            ],
            options={
                'verbose_name': 'Entry',
